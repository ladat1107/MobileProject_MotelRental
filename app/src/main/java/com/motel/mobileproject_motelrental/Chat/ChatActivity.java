package com.motel.mobileproject_motelrental.Chat;
...
import com.motel.mobileproject_motelrental.Adapter.ChatAdapter;
...
import com.motel.mobileproject_motelrental.PreferenceManager;
import com.motel.mobileproject_motelrental.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private void init() {
        ...
        chatAdapter = new ChatAdapter(
                chatMessages, getBitmapFromEncodedString(receiverUser.image), preferenceManager.getString(Constants.KEY_USER_ID)
        );
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).document(receiverUser.id)
                .addSnapshotListener(ChatActivity.this, ((value, error) -> {
                    ...
                    if (isReceiverAvailable) {
                        ...
                        binding.textAvaibility.setVisibility(View.INVISIBLE);
                    }
                }));
    }
